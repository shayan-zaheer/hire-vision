...
function Navbar() {
  return (
    <div className="sticky top-4 px-4 py-2 bg-white/10 backdrop-blur-lg rounded-full border border-white/20 shadow-lg font-ubuntu mx-8 flex sm:justify-between text-gray-300 z-50 justify-center">
